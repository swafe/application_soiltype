...
* copy the following link:  ``` https://github.com/swafe/Masterthesis/blob/master/Mask_rcnn_small_tf1_detect_samples/test_Mask_rcnn_small_tf1_soilsample_model.ipynb ```
