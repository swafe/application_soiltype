...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 soilsample.py train --dataset=/path/to/soilsample/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 soilsample.py train --dataset=/path/to/soilsample/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 soilsample.py train --dataset=/path/to/soilsample/dataset --weights=imagenet

    # Apply color splash to an image
    python3 soilsample.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 soilsample.py splash --weights=last --video=<URL or path to file>
"""
...
class SoilsampleConfig(Config):
    ...
    NUM_CLASSES = 1 + 19  # Background + soilsample
...
class SoilsampleDataset(utils.Dataset):

    def load_soilsample(self, dataset_dir, subset):
        """Load a subset of the soilsample dataset.
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a soilsample dataset image, delegate to parent class.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect soilsamples.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/soilsample/dataset/",
                        help='Directory of the soilsample dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(SoilsampleConfig):
